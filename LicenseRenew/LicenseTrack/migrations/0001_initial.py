    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userRole', models.CharField(choices=[('superuser', 'Superuser'), ('admin', 'Admin')], default='admin', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscriptions', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='LicenseTrack.subscriptions')),
